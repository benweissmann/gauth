...
ADMINS = (
    ('TODO: your username', 'TODO: your email'),
)
...
TEMPLATE_DIRS = (
    SITE_ROOT + '/redirector/templates',
...
# Put your Google API key here. You'll need to enable the google shortening
# service on your API account.
GOOGLE_API_KEY = 'TODO: enter your Google API key'

# Put the URL of your Gauth server here. Gauth uses this to provide users with
# redirection URLs, so this must be the URL of an HTTPS server that checks
